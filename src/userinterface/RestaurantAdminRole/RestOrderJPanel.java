...
public class RestOrderJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblRestWorkList.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        lblRestWorkList.setForeground(new java.awt.Color(0, 51, 51));
        lblRestWorkList.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblRestWorkList.setText("Restaurant Work List");
        add(lblRestWorkList, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 30, -1, -1));
        ...
        add(scrollOrderList, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, 770, 110));

        brnConfirmOrder.setBackground(new java.awt.Color(204, 255, 255));
        brnConfirmOrder.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ...
        add(scrollDeliveryMan, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 210, 407, 116));

        btnAssignDeliveryMan.setBackground(new java.awt.Color(204, 255, 255));
        btnAssignDeliveryMan.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ...
        add(btnAssignDeliveryMan, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 340, 140, 30));
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, 50, 30));
