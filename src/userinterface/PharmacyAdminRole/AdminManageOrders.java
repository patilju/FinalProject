...
public class AdminManageOrders extends javax.swing.JPanel {
    ...
    public AdminManageOrders(JPanel userProcessContainer, Pharmacy pharmacy) {
        ...
        PharmacyAMOvalueLabel2.setText(pharmacy.getPharmacyName());
        populateTable();
        ...
        {
            System.out.println(dm.getDeliveryManName());
            PharmacyAMOCombo.addItem(dm.getDeliveryManName());
        }
    }
        ...
        if(pharmacy.getOrderDirectory().getOrderList() != null)
        {
            for(Orders orders : pharmacy.getOrderDirectory().getOrderList())
            {
                if(!orders.isStatus())
                {
                    ...
                    {
                        row[3] = orders.getDeliveryMan().getDeliveryManName();
                    }
                    dtm.addRow(row);
                }
            }
